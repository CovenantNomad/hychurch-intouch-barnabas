...
import { getBarnabasProfile } from '@/repositories/barnabas';
...
const BarnabaProfileCard = ({ barnabasId }: Props) => {
  const { isLoading, isFetching, data } = useQuery({
    queryKey: ['getBarnabasProfile', barnabasId],
    queryFn: () => getBarnabasProfile(barnabasId),
    staleTime: 5 * 60 * 1000,
    gcTime: 30 * 60 * 1000,
    enabled: !!barnabasId,
  });
...
export default BarnabaProfileCard;
